...
controller=adaptiveController(A_discr,B_discr,matC, D_discr, Q, R,2,N,min_N, dt);
...
ylabel('Signal');
[t_alg,state_alg, control_alg, J_alg]=simulation(T,matACont,matBCont(:,1:end-1),matC,matBCont(:,end),Q,controller,quakeHandle);
subplot(2,2,2);
